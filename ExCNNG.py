...
def image_loader(image_name):
    image = Image.open(image_name).convert('RGB')  # 灰度图或单通道图像都转成三通道
...
def image_unloader(tensor):
    ...
    image = unloader(image)  # [C,H,W] → PIL
    return image
...
IMAGE1_PATH = 'grouped_train2000_trans0.5/GBarbara'
TARGET_PATH = 'a/a.png'
...
model_save_path = 'saved_822_GBarbara'
...
IMAGE1_PATH = 'grouped_test/GBarbara'
SAVE_PATH = 'result822/GBarbara'
...
#
# # 模型保存路径
# model_path = 'saved_822_9/excnn_best.pth'
#
# # 测试集路径
# IMAGE1_PATH = 'grouped_test/pingyi0.3/boat'
# SAVE_PATH = 'result822/boat_trans0.3'
#
# if not os.path.exists(SAVE_PATH):
